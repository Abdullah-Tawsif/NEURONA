...
window.addEventListener('scroll', () => {
  ...
  if (window.scrollY > 50) {
    ...
    // Swap to the white logo asset when scrolled
    if (logo) logo.src = "/static/images/logo_white.png"; 
  } else {
    navbar.classList.remove('scrolled', 'dark');
    navbar.classList.add('light');
    // Swap back to the black logo asset at the top
    if (logo) logo.src = "/static/images/logo_black.png";
  }
});
