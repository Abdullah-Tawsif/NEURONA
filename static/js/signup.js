...
function validatePassword() {
  ...
  var isValid = value.length >= 8 && /[!@#$%^&*(),.?":{}|<>]/.test(value);
  if (isValid) {
...
email.addEventListener('input', function () { validateEmail(); validateForm(); });
password.addEventListener('input', function () { validatePassword(); validateConfirm(); validateForm(); });
confirm.addEventListener('input', function () { validateConfirm(); validateForm(); });
